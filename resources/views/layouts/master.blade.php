...
<html lang="en">
    <head>
        ...
        <meta property="og:title" content="HTML & Laravel" />
        <meta property="og:url" content="https://souysoeng.com" />
        <meta property="og:site_name" content="StarCode Kh" />
    ...
    <body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-toolbar-enabled="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" class="app-default">
                ...
                <div id="kt_app_header" class="app-header" data-kt-sticky="true" data-kt-sticky-activate="{default: true, lg: true}" data-kt-sticky-name="app-header-minimize" data-kt-sticky-offset="{default: '200px', lg: '300px'}" data-kt-sticky-animation="false">
                    <div class="app-container container-fluid d-flex align-items-stretch flex-stack" id="kt_app_header_container">
                        <div class="d-flex align-items-center d-block d-lg-none ms-n3" title="Show sidebar menu">
                            ...
                            <a href="{{ route('home') }}">
                                <img alt="Logo" src="{{ URL::to('assets/media/logos/default-dark.svg') }}" class="h-30px" />
                            </a>
                        </div>
                                ...
                                <div id="kt_header_search" class="header-search d-flex align-items-center w-lg-350px" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter" data-kt-search-layout="menu" data-kt-search-responsive="true" data-kt-menu-trigger="auto" data-kt-menu-permanent="true" data-kt-menu-placement="bottom-end">
                                    ...
                                    <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                                        ...
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <a href="index.htm-1.html?page=pages/search/horizontal" class="btn btn-sm fw-bold btn-primary" data-kt-search-element="advanced-options-form-search">Search</a>
                                        </div>
                                    </form>
                                ...
                                <div class="timeline-content mb-10 mt-n1">
                                    ...
                                    <div class="overflow-auto pb-5">
                                        <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
                                            <a href="index.htm-41.html?page=apps/projects/project" class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Meeting with customer</a>
                                            ...
                                            <a href="index.htm-41.html?page=apps/projects/project" class="btn btn-sm btn-light btn-active-light-primary">View</a>
                                        </div>
                                        <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">
                                            <a href="index.htm-41.html?page=apps/projects/project" class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Project Delivery Preparation</a>
                                        ...
                                        <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                                            <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                                ...
                                                <div class="ms-1 fw-semibold">
                                                    <a href="index.htm-41.html?page=apps/projects/project" class="fs-6 text-hover-primary fw-bold">Finance KPI App Guidelines</a>
                                                    <div class="text-gray-400">1.9mb</div>
                                                </div>
                                            </div>
                                            <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                                <img alt="/open-html-pro/?page=apps/projects/project" class="w-30px me-3" src="assets/media/svg/files/doc.svg" />
                                                <div class="ms-1 fw-semibold">
                                            ...
                                            <div class="d-flex flex-aligns-center">
                                                <img alt="/open-html-pro/?page=apps/projects/project" class="w-30px me-3" src="assets/media/svg/files/css.svg" />
                                                <div class="ms-1 fw-semibold">
                    ...
                    <div class="card-toolbar">
                        <div class="me-2">
                            <button class="btn btn-sm btn-icon btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                                <i class="ki-duotone ki-dots-square fs-3"><i class="path1"></i><i class="path2"></i><i class="path3"></i><i class="path4"></i></i>
                            </button>
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link flex-stack px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_invite_friends">
                                        Invite Contacts
                                        <span class="ms-2" data-bs-toggle="tooltip" title="Specify a contact email to send an invitation"> </span>
                                    </a>
                                </div>
                ...
                <div class="card-body hover-scroll-overlay-y h-400px pt-5">
                    <div class="d-flex flex-stack">
                        <div class="d-flex flex-column me-3">
                            <div class="mb-3">
                                <a href="index.htm-55.html?page=apps/ecommerce/sales/details" class="text-gray-800 text-hover-primary fs-4 fw-bold">Iblender</a>
                    ...
                    <div class="d-flex flex-stack">
                        <div class="d-flex flex-column me-3">
                            <div class="mb-3">
                                <a href="index.htm-55.html?page=apps/ecommerce/sales/details" class="text-gray-800 text-hover-primary fs-4 fw-bold">SmartCleaner</a>
                    ...
                    <div class="d-flex flex-stack">
                        <div class="d-flex flex-column me-3">
                            <div class="mb-3">
                                <a href="index.htm-55.html?page=apps/ecommerce/sales/details" class="text-gray-800 text-hover-primary fs-4 fw-bold">CameraMaxr</a>
                    ...
                    <div class="d-flex flex-stack">
                        <div class="d-flex flex-column me-3">
                            <div class="mb-3">
                                <a href="index.htm-55.html?page=apps/ecommerce/sales/details" class="text-gray-800 text-hover-primary fs-4 fw-bold">$D Printer</a>
                    ...
                    <div class="d-flex flex-stack">
                        <div class="d-flex flex-column me-3">
                            <div class="mb-3">
                                <a href="index.htm-55.html?page=apps/ecommerce/sales/details" class="text-gray-800 text-hover-primary fs-4 fw-bold">MotionWire</a>
                    ...
                    <div class="d-flex flex-stack">
                        <div class="d-flex flex-column me-3">
                            <div class="mb-3">
                                <a href="index.htm-55.html?page=apps/ecommerce/sales/details" class="text-gray-800 text-hover-primary fs-4 fw-bold">Samsung</a>
                    ...
                    <div id="kt_explore_scroll" class="scroll-y me-n5 pe-5" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_explore_body" data-kt-scroll-dependencies="#kt_explore_header, #kt_explore_footer" data-kt-scroll-offset="5px">
                        <div class="rounded border border-dashed border-gray-300 py-6 px-8 mb-5">
                            ...
                            <div class="d-flex flex-column flex-center mb-3">
                                <div class="mb-3 text-gray-500 fw-semibold fs-6">Secured Payment by <a href="https://www.2checkout.com/" target="_black" class="fw-bold text-dark explore-link-hover me-1">2Checkout</a> with:</div>
                                <div class="mb-2">
                                ...
                                <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-35px symbol-circle">
                                            <img alt="Pic" src="{{ URL::to('assets/media/avatars/300-3.jpg') }}" />
                                        </div>
                                        <div class="ms-5">
                                                        ...
                                                        <span class="d-flex align-items-center me-2">
                                                            ...
                                                            <span class="symbol symbol-50px me-6">
                                                                <span class="symbol-label bg-light-success">
                                                                    <i class="ki-duotone ki-timer fs-1 text-success"><i class="path1"></i><i class="path2"></i><i class="path3"></i></i>
                                                                </span>
                                                            </span>
                                                            <!--end:Icon-->
                                        ...
                                        <div>
                                            <button type="button" class="btn btn-lg btn-primary" data-kt-stepper-action="submit">
                                                <span class="indicator-label">
                                                    Submit
                                                    <i class="ki-duotone ki-arrow-right fs-3 ms-2 me-0"><i class="path1"></i><i class="path2"></i></i>
                                                </span>
                                            ...
                                            <button type="button" class="btn btn-lg btn-primary" data-kt-stepper-action="next">
                                                Continue
                                                <i class="ki-duotone ki-arrow-right fs-3 ms-1 me-0"><i class="path1"></i><i class="path2"></i></i>
                                            </button>
                                        </div>
                                        <!--end::Wrapper-->
                                    </div>
                            ...
                            <div class="py-5">
                                    ...
                                    <div class="mh-375px scroll-y me-n7 pe-7">
                                        <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="0">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="symbol symbol-35px symbol-circle">
                                                    <img alt="Pic" src="{{ URL::to('assets/media/avatars/300-6.jpg') }}" />
                                                </div>
                                                <div class="ms-5">
                                                    <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Emma Smith</a>
                                                    <div class="fw-semibold text-muted">smith@kpmg.com</div>
                                ...
                                <div data-kt-search-element="empty" class="text-center d-none">
                                    ...
                                    <div class="text-center px-5">
                                        <img src="{{ URL::to('assets/media/avatars/300-3.jpg') }}" alt="" class="w-100 h-200px h-sm-325px" />
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script src="{{ URL::to('../lib/5/index.js') }}"></script>
        <script src="{{ URL::to('../lib/5/xy.js') }}"></script>
        <script src="{{ URL::to('../lib/5/percent.js') }}"></script>
        <script src="{{ URL::to('../lib/5/radar.js') }}"></script>
        <script src="{{ URL::to('../lib/5/themes/Animated.js') }}"></script>
        <script src="{{ URL::to('../lib/5/map.js') }}"></script>
        <script src="{{ URL::to('../lib/5/geodata/worldLow.js') }}"></script>
        <script src="{{ URL::to('../lib/5/geodata/continentsLow.js') }}"></script>
        <script src="{{ URL::to('../lib/5/geodata/usaLow.js') }}"></script>
        <script src="{{ URL::to('../lib/5/geodata/worldTimeZonesLow.js') }}"></script>
        <script src="{{ URL::to('../lib/5/geodata/worldTimeZoneAreasLow.js') }}"></script>
        ...
        <script src="{{ URL::to('../../../assets/js/custom/apps/user-management/users/list/add.js') }}"></script>
