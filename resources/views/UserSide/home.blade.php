                ...
                <div class="relative">
                    <div class="max-w-2xl lg:max-w-5xl">
                        <div class="relative flex mb-6 items-center">
                            ...
                            <input type="search" id="searchInput" placeholder="Search rss Items" class="rounded-md border border-zinc-900/10 bg-gray-50 px-20 py-3 shadow-md shadow-zinc-800/5
        ...
        <div class="mt-2 pl-20 grid gap-10 md:grid-cols-2 lg:gap-10 xl:grid-cols-2">
            ...
            <div class="group cursor-pointer ">
                <div class="flex flex-col justify-center">
                    <div <div class="relative flex flex-col md:flex-row md:space-x-5 space-y-3 md:space-y-0 rounded-xl p-3 max-w-xs md:max-w-3xl mx-auto border border-white transition-all duration-300 transform hover:scale-105 shadowrss shadow-xl">
                        ...
                        <div class="w-full md:w-2/3 bg-white flex flex-col space-y-2 p-3">
                            <div class="flex justify-between item-center">
                                ...
                                <!-- <div
                                    ...
                                    fill="currentColor">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-pink-500" viewBox="0 0 20 20" fill="currentColor">
                                ...
                                <form action="{{ route('addToFavorites', $rssItem->id) }}" method="POST">
                                    @csrf
                                    <button type="submit" class="flex items-center justify-center bg-gray-100 rounded-full p-2 hover:bg-gray-200 focus:outline-none">
