        ...
        <div id="kt_app_toolbar" class="app-toolbar ">
            <div id="kt_app_toolbar_container"
                ...
                <div class="page-title d-flex align-items-center gap-1 me-3" data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}"data-kt-swapper-parent="{default: '#kt_app_content_container', lg: '#kt_app_header_wrapper'}">
                    <span class="text-gray-900 fw-bolder fs-2x">View Users</span>
                            ...
                            <div class="card mb-5 mb-xl-8">
                                <div class="card-body">
                                    <div class="d-flex flex-center flex-column py-5">
                                        @if(!empty($userView->avatar))
                                            <div class="symbol symbol-100px symbol-circle mb-7">
                                                <img src="{{ URL::to('/assets/media/avatars/300-3.jpg') }}" alt="image">
                                            </div>
                                        @else
                                            <div class="symbol symbol-100px symbol-circle mb-7">
                                                <img src="{{ URL::to('/assets/media/svg/files/blank-image.svg') }}" alt="image">
                                            </div>
                                        @endif
                                        ...
                                        <div class="fw-bold mb-3">
                                            Assigned Tickets
                                            <span class="ms-2" ddata-bs-toggle="popover" data-bs-trigger="hover" data-bs-html="true" data-bs-content="Number of support tickets assigned, closed and pending this week."></span>
                                        </div>
                                    ...
                                    <div id="kt_user_view_details" class="collapse show">
                                        <div class="pb-5 fs-6">
                                            ...
                                            <div class="text-gray-600">{{ $userView->user_id }} </div>
                                            <div class="fw-bold mt-5">Email</div>
                                            <div class="text-gray-600">
                                                <a href="#" class="text-gray-600 text-hover-primary">{{ $userView->email }} </a>
                                            </div>
                                            ...
                                            <div class="text-gray-600">{{ $userView->join_date }} </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="d-flex flex-stack flex-grow-1 ">
                                            <div class=" fw-semibold">
                                                <div class="fs-6 text-gray-700 ">
                                                    ...
                                                    <a href="#" class="me-1">privacy policy</a> and <a href="#">terms of use</a>.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold py-4 w-250px fs-6" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-5">
                                            <a href="#" class="menu-link flex-stack px-5">
                                                Create payments
                                                <span class="ms-2" data-bs-toggle="tooltip" title="Specify a target name for future usage and reference"></span>
                                            </a>
                                        </div>
                                                    ...
                                                    <div class="d-flex flex-stack position-relative mt-6">
                                                        ...
                                                        <div class="fw-semibold ms-5">
                                                            <div class="fs-7 mb-1">
                                                                16:30 - 17:30
                                                                <span
                                                                    class="fs-7 text-muted text-uppercase">
                                                                    pm </span>
                                                            </div>
                                                            <!--end::Time-->
                                        ...
                                        <div class="card-header mt-6">
                                            ...
                                            <div class="card-toolbar">
                                                <button type="button" class="btn btn-light-primary btn-sm"
                                                    ...
                                                    <i class="ki-duotone ki-add-files fs-3"><i
                                                            class="path1"></i><i class="path2"></i><i
                                                            class="path3"></i></i> Add Task
                                                </button>
                                            </div>
                                            <!--end::Card toolbar-->
                                        </div>
                                        ...
                                        <div class="card-body d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center position-relative mb-7">
                                                ...
                                                <button type="button"
                                                    ...
                                                    <i class="ki-duotone ki-setting-3 fs-3"><i
                                                            class="path1"></i><i class="path2"></i><i
                                                            class="path3"></i><i class="path4"></i><i
                                                            class="path5"></i></i> </button>
                                            ...
                                            <div class="d-flex align-items-center position-relative mb-7">
                                                ...
                                                <div class="fw-semibold ms-5">
                                                    <a href="#"
                                                        class="fs-5 fw-bold text-dark text-hover-primary">9
                                ...
                                <div class="tab-pane fade" id="kt_user_view_overview_security"
                                    ...
                                    <div class="card pt-4 mb-6 mb-xl-9">
                                        ...
                                        <div class="card-header border-0">
                                            ...
                                            <div class="card-toolbar">
                                                ...
                                                <button type="button" class="btn btn-light-primary btn-sm"
                                                    data-kt-menu-trigger="click"
                                                    data-kt-menu-placement="bottom-end">
                                                    <i class="ki-duotone ki-fingerprint-scanning fs-3"><i
                                                            class="path1"></i><i class="path2"></i><i
                                                            class="path3"></i><i class="path4"></i><i
                                                            class="path5"></i></i> Add Authentication Step
                                                </button>
                                                <!--begin::Menu-->
                                        ...
                                        <div class="card-body pb-5">
                                            ...
                                            <div class="d-flex flex-stack">
                                                ...
                                                <div class="d-flex justify-content-end align-items-center">
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        <i class="ki-duotone ki-trush fs-3"></i> </button>
                                                    <!--end::Button-->
                                                </div>
                                                <!--end::Action-->
                                            </div>
                                            ...
                                            <!--begin::Disclaimer-->
                                            <div class="text-gray-600">
                                                If you lose your mobile device or security key, you can <a
                                                    href='#' class="me-1">generate a backup code</a> to sign
                                                in to your account.
                                            </div>
                                            <!--end::Disclaimer-->
                                        </div>
                                    ...
                                    <div class="card pt-4 mb-6 mb-xl-9">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form class="form" id="kt_users_email_notification_form">
                                                ...
                                                <div
                                                    class="d-flex justify-content-end align-items-center mt-12">
                                                    <!--begin::Button-->
                                        ...
                                        <div class="card-header border-0">
                                            ...
                                            <div class="card-toolbar">
                                                ...
                                                <button type="button"
                                                    ...
                                                    <i class="ki-duotone ki-entrance-right fs-3"><i
                                                            class="path1"></i><i class="path2"></i></i> Sign
                                                    out all sessions
                                                </button>
                                                <!--end::Filter-->
                                            </div>
                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <!--begin::Status--->
                                                            <td>
                                                                POST /v1/invoices/in_3086_4964/payment </td>
                                                            <!--end::Status--->
                                                        ...
                                                        <tr>
                                                            ...
                                                            <!--begin::Status--->
                                                            <td>
                                                                POST /v1/invoices/in_6141_1855/payment </td>
                                                            <!--end::Status--->
                                                        ...
                                                        <tr>
                                                            ...
                                                            <!--begin::Status--->
                                                            <td>
                                                                POST /v1/customer/c_6430137dca471/not_found
                                                            </td>
                                                            <!--end::Status--->
                                                        ...
                                                        <tr>
                                                            ...
                                                            <!--begin::Status--->
                                                            <td>
                                                                POST /v1/invoice/in_3018_7344/invalid </td>
                                                            <!--end::Status--->
                                                        ...
                                                        <tr>
                                                            ...
                                                            <!--begin::Status--->
                                                            <td>
                                                                POST /v1/customer/c_6430137dca473/not_found
                                                            </td>
                                                            <!--end::Status--->
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="min-w-400px">
                                                            ...
                                                            status has changed from <span
                                                                class="badge badge-light-warning me-1">Pending</span>
                                                            to <span class="badge badge-light-info">In
                                                                Progress</span>
                                                        </td>
                                                        <!--end::Event--->
                                ...
                                <form class="form" action="#" id="kt_modal_update_user_form">
                                    ...
                                    <div class="modal-header" id="kt_modal_update_user_header">
                                        ...
                                        <div class="btn btn-icon btn-sm btn-active-icon-primary"
                                            ...
                                            <i class="ki-duotone ki-cross fs-1"><i class="path1"></i><i
                                                    class="path2"></i></i>
                                        </div>
                                        <!--end::Close-->
                                    </div>
                                                    ...
                                                    <div class="mt-1">
                                                        ...
                                                        <div class="image-input image-input-outline image-input-placeholder"
                                                            ...
                                                            <div class="image-input-wrapper w-125px h-125px"
                                                                style="background-image: url(/open-html-pro/assets/media/avatars/300-6.jpg">
                                                            </div>
                                    ...
                                    <form class="form" id="kt_modal_add_one_time_password_form">
                                        ...
                                        <div class="fv-row mb-7">
                                            <label class="fs-6 fw-semibold form-label mb-2">
                                                ...
                                                <span class="ms-2" data-bs-toggle="tooltip" title="A valid mobile number is required to receive the one-time password to validate your account login."></span>
                                            </label>
